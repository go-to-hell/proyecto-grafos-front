<template>
  <div class="flex flex-col items-start justify-start w-full py-12 space-y-6">
    <button
      @click="goBack"
      class="absolute top-0 left-0 flex items-center justify-center w-12 h-12 mt-6 ml-6 text-gray-500 rounded-pill bg-body-secondary shadow-md hover:bg-gray-100"
    >
      <svg
    ...
    <h2 class="font-mono mb-5 text-4xl text-center font-bold">Registrarse</h2>
