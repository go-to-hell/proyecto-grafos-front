        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>
              ...
              Selecciona si es que quieres maximizar o minimizar el camino y
              selecciona el nodo de inicio, luego dale al botón de resolver.
            </p>
            <img
  ...
  {{ edges.label }}
    ...
    <div class="position-absolute top-0 end-0 m-1 text-end">
      ...
      <div class="pt-3 text-center">
        ...
        />
        <label
          :class="maximize ? 'text-success' : 'text-info'"
      ...
      <button
          type="button"
          data-bs-title="Resolver Dijkstra."
    ...
    <!-- View Controls -->
    <div
      class="d-md-flex d-block gap-5 w-100 justify-content-center position-absolute sticky-bottom py-3 px-3 py-md-4 px-md-5"
    ...
    >
      <div class="d-flex gap-2 gap-md-5 mb-2 mb-md-0">
        <button
          ...
          :class="isAddingNode === true ? 'btn btn-success' : 'btn btn-info'"
      ...
      <div class="d-flex gap-2 gap-md-5">
        ...
        <button
          ...
          class="btn btn-warning bi bi-floppy rounded-circle py-3 px-4"
          @click="openFileNameModal"
        ></button>
        <button
          type="button"
          ...
          data-bs-custom-class="custom-tooltip"
          data-bs-title="Abrir."
          class="btn btn-warning bi bi-folder2-open rounded-circle py-3 px-4"
          @click="openGraphFile"
        ></button>
        <button
          type="button"
          ...
          class="btn btn-warning bi bi-file-earmark-x rounded-circle py-3 px-4"
...
const solveDijkstra = async () => {
  try {
    ...
    console.log("DijkstraDataOutput:", algorithmStore.dijkstraDataOutput);
    console.log("Dijkstra paths:", algorithmStore.dijkstraDataOutput.edges);
  } catch (error) {
...
const confirmClearAll = () => {
  ...
  algorithmStore.dijkstraDataOutput = null;
  paths.value = {};
