  ...
  <div>
      ...
      <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <img src="../assets/RK.png" alt="Resolver" class="img-fluid" />
            <p>
              <strong>Resolver 🧠</strong><br />
              Selecciona entre maximizar y minimizar, dale al boton de resolver
              y disfruta.
            </p>
            <img src="../assets/ResK.png" alt="Resultado" class="img-fluid" />
            <p>
              <strong>Resultado</strong><br />
              El editor te mostrará la ruta crítica y marcará el camino en el
              grafico de gráfos resaltando las aristas de la ruta crítica.
            </p>
            <img
    ...
    <div class="position-absolute top-0 end-0 m-1 text-center">
      ...
      <div class="px-4 py-3">
        ...
        />
        <label
          :class="{ 'text-success': maximize, 'text-info': !maximize }"
      ...
      <button
        ...
        data-bs-title="Resolver Kruskal."
    ...
    >
      ...
      <div class="offcanvas-body">
        ...
        <div class="d-flex gap-3">
          ...
          ></button>
          <button
            class="btn btn-outline-danger bi bi-dash-circle w-100 py-2 mt-1"
            @click="zoomOut"
          ></button>
        </div>
        <button
          ...
          :class="
            isBoxSelectionMode
              ? 'btn btn-danger w-100 py-2 mt-3'
    ...
    <!-- View Controls -->
    <div
      class="d-md-flex d-block gap-5 w-100 justify-content-center position-absolute sticky-bottom bg-body-secondary border border-3 py-3 px-3 py-md-4 px-md-5"
    >
      <div class="d-flex gap-2 gap-md-5 mb-2 mb-md-0">
        <button
          ...
          :class="
            isAddingNode === true ? 'btn btn-warning' : 'btn btn-outline-info'
          "
...
const solveKruskal = async () => {
  ...
  await algorithmStore.loadKruskalsTreeEdges(jsonData, maximize.value);

  // por cada arista en el árbol de expansión mínima, se agrega un nuevo path
  let kruskalsTreeEdges = algorithmStore.getKruskalsTreeEdges();
  if (kruskalsTreeEdges !== null) {
    paths.value = kruskalsTreeEdges;
  }

  // Muestra las aristas críticas en la consola
  console.log("Kruskal MST Edges:", algorithmStore.kruskalsTreeEdgesDataOutput);
};
...
const confirmClearAll = () => {
  ...
  algorithmStore.kruskalsTreeEdgesDataOutput = null;
  paths.value = {};
