<template>
  ...
  <div class="container">
    ...
    <div class="btn-group mb-4" role="group">
      <a class="btn graphs-button" href="#Graphs" id="Graphs">Grafos</a>
      <a class="btn johnson-button" href="#Johnson" id="Johnson">Johnson</a>
      <a class="btn assignment-button" href="#Assignment" id="Asignation"
        >Asignación</a
      >
      <a class="btn northWest-button" href="#NorthWest" id="NorthWest"
        >North West</a
      >
      <a class="btn sorts-button" href="#Sorts" id="Sorts">Sorts</a>
      <a class="btn binaryTrees-button" href="#BinaryTrees" id="BinaryTrees"
        >Árboles Binarios</a
      >
      <a class="btn kruskal-button" href="#Kruskal" id="Kruskal">Kruskal</a>
      <a class="btn dijkstra-button" href="#Dijkstra" id="Dijkstra">Dijkstra</a>
      <a class="btn compet-button" href="#Compet" id="Compet">Compet</a>
    </div>
